...
!echo! 99-audio.c     && !cc! !o! 99-audio.exe      demos\99-audio.c        !import! !args! || set rc=1                              
!echo! 99-cubemap.c   && !cc! !o! 99-cubemap.exe    demos\99-cubemap.c      !import! !args! || set rc=1                                    
!echo! 00-demo.c      && !cc! !o! 00-demo.exe       demos\00-demo.c         !import! !args! || set rc=1                           
!echo! 99-easing.c    && !cc! !o! 99-easing.exe     demos\99-easing.c       !import! !args! || set rc=1                                 
!echo! 99-font.c      && !cc! !o! 99-font.exe       demos\99-font.c         !import! !args! || set rc=1                           
!echo! 00-hello.c     && !cc! !o! 00-hello.exe      demos\00-hello.c        !import! !args! || set rc=1                              
!echo! 99-instanced.c && !cc! !o! 99-instanced.exe  demos\99-instanced.c    !import! !args! || set rc=1                                          
!echo! 99-material.c  && !cc! !o! 99-material.exe   demos\99-material.c     !import! !args! || set rc=1                                       
!echo! 99-script.c    && !cc! !o! 99-script.exe     demos\99-script.c       !import! !args! || set rc=1                                 
!echo! 99-shadertoy.c && !cc! !o! 99-shadertoy.exe  demos\99-shadertoy.c    !import! !args! || set rc=1                                          
!echo! 99-spine.c     && !cc! !o! 99-spine.exe      demos\99-spine.c        !import! !args! || set rc=1                              
!echo! 99-sprite.c    && !cc! !o! 99-sprite.exe     demos\99-sprite.c       !import! !args! || set rc=1                                 
!echo! 99-video.c     && !cc! !o! 99-video.exe      demos\99-video.c        !import! !args! || set rc=1                              
)
